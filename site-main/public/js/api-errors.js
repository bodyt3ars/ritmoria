(() => {
  const ERROR_MESSAGES = {
    ...
    username_tag_taken: "Этот username уже занят.",
    ...
    queue_not_open: "Очередь сейчас закрыта или на паузе.",
    queue_track_exists: "Этот трек уже добавлен в очередь.",
    profile_track_not_found: "Трек из профиля не найден.",
    profile_track_rate_failed: "Не удалось сохранить оценку трека.",
    profile_track_my_rating_failed: "Не удалось загрузить твою прошлую оценку.",
    cannot_rate_own_track: "Нельзя оценивать свой трек.",
    self_rate_forbidden: "Нельзя ставить оценку своему треку.",
